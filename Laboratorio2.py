...
if __name__ == "__main__":
    '''El programa solo tiene un máximo de resolución de 7 piezas en el rompecabezas considerando un tiempo prudente de espera. Con 10 piezas en
    ...
    '''Las variables start y end son para determinar el tiempo que transcurrio durante la resolución del problema'''
    start = time.time()
    ...
    resultado.reverse()
    print(resultado)
    print("El tiempo transcurrido fue de: ",end-start," segundos")